...
for(i in 1:nrow(pars1)){
  ...
  my.constants <- list(N = nrow(y), T = ncol(y)-1,miss_clo2=miss_clo2,nrmc=nrow(miss_clo2),sex=as.numeric(start_info[[1]]$sex),me_t=me_t,sd_t=sd_t)
  ...
  results<-list(SAMP_RES_C,SAMP_RES_L,FULL_RES_C,FULL_RES_L)
