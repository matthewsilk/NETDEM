...
SAMP_RES3<-FULL_RES3<-array(NA,dim=c(4,7,reps))
...
SAMP_RES3[,,r]<-as.matrix(store_res)
...
FULL_RES3[,,r]<-as.matrix(store_res2)

print(r)

}

#saveRDS(SAMP_RES3,"SAMP_RES3.RDS")
#saveRDS(FULL_RES3,"FULL_RES3.RDS")

par(xpd=FALSE)
plot(SAMP_RES3[3,1,]~FULL_RES3[3,1,],xlim=c(-1.5,0.5),ylim=c(-1.5,0.5))
lines(x=seq(-100,100,1),y=seq(-100,100,1),lty=3)
lines(x=rep(-0.75,2),y=c(-100,100),lty=1)
lines(y=rep(-0.75,2),x=c(-100,100),lty=1)
cor.test(FULL_RES3[3,1,],SAMP_RES3[3,1,])
